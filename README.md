...
Для быстрого обзора текущего и предыдущего контрактов МТС, их conformance-состояния и машинных свидетельств доступен **Contract Observatory**:

**[Открыть Contract Observatory](https://netkeep80.github.io/anum_docs/)**
...
`contracts/**`, `cutover/**` и `repo-policy.json` остаются source of truth. GitHub Pages можно пересобрать из этих данных; доступность самого URL зависит от настроек GitHub Pages репозитория.
