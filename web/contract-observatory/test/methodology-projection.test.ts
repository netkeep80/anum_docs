...
same(candidate.executableGates.length, 5, "C6 candidate projects C2 falsifier, C3 STRING runtime, C4 FORMAL square-bracket, C5 Q/representation and C6 FORMAL/explicit-K/left-reading gates");
