...
/**
 * Candidate C for #970: both field order and occurrence order are expressed by
 * the same nested-pair triad form rather than by generic descriptor objects plus
 * ExactSequence Cells.
 *
 *   F0 = R
